...
- (void)_commonInit
{
    ...
    //背景色//commintBtnColor
    UIColor *normalColor=UIColorFromHexToRGB(0x8b8b8b);
       UIColor *HighlightedColor=UIColorFromHexToRGB(0x595959);
         UIColor *SelectedColor=UIColorFromHexToRGB(0x595959);
...
//        [button setBackgroundImage:[WPSFactory imageWithColor:normalColor] forState:UIControlStateSelected];
//        
//      
//        [button setBackgroundImage:[WPSFactory imageWithColor:HighlightedColor] forState:UIControlStateHighlighted];
////
               [button setBackgroundImage:[WPSFactory imageWithColor:normalColor] forState:UIControlStateNormal];
...
//    UIImage *backspaceImage=[UIImage imageNamed:@"deleteButton"];
    UIImage *backspaceImage=[UIImage imageNamed:@"deleteButton"];
    ...
    [backspaceButton setBackgroundImage:[WPSFactory imageWithColor:SelectedColor] forState:UIControlStateNormal];
    ...
    //背景色//backbutton
    [decimalPointButton setBackgroundImage:[WPSFactory imageWithColor:SelectedColor] forState:UIControlStateNormal];
...
- (void)_buttonInput:(UIButton *)button
{
    ...
    if ([delegate respondsToSelector:@selector(updateTextContent)]) {
           [self.delegate updateTextContent];
    }
...
//        rect.origin.x = numberSize.width * 2;
    ...
    for (NSInteger idx = 0; idx < sizeof(utilityButtonKeys) / sizeof(int); idx++) {
        ...
        CGRect rect1 = (CGRect){ .size = numberSize };
        rect1.origin.y = numberSize.height * 3;
        rect1.origin.x = numberSize.width * 2;
        
        [button setFrame:MMButtonRectMake(rect1, contentRect, interfaceIdiom)];
    }
        ...
        if (separatorViews.count != numberOfSeparators) {
            ...
            if (removes) {
                ...
                while (separatorsToInsert--) {
                    ...
                    separator.backgroundColor = UIColorFromHexToRGB(0x595959);
...
//        highlightedFillColor=[UIColor redColor];
//        
